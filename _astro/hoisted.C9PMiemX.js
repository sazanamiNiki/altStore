import"./hoisted.4rKrRCEY.js";import"./hoisted.mGvHz-GO.js";function d(){if(document.getElementById("lightbox-modal"))return;const e=document.createElement("div");e.id="lightbox-modal",e.className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 hidden",e.innerHTML=`
