...
<ArticleLayout title={title} h1={h1} summary={summary} description={description} date="2026-04-11" icon="shield" iconColor="text-blue-500">
...
<RelatedArticles articles={[
  {
    ...
    title: '代替マーケットプレイスとは？',
    desc: '公証が必須となる代替マーケットプレイスの仕組みを制度面から解説。',
  },
  {
