...
<ArticleLayout title={title} h1={h1} description={description} date="2026-03-10" icon="shield" iconColor="text-blue-500">
...
<Section title="Apple公証（Notarization）とは" icon="verified" iconColor="text-green-600">
  ...
  <CardGrid>
    <Card icon="store" iconColor="text-blue-500" title="App Store審査" desc="人による品質審査" />
    <Card icon="verified" iconColor="text-green-500" title="公証" desc="自動セキュリティ検査" />
  </CardGrid>
  <AccordionGroup>
    <Accordion title="審査と公証の違いを詳しく見る">
      <p class="text-sm text-gray-700 mb-2"><strong>App Store審査：</strong>人間による品質・ポリシー審査。数時間〜数日かかることも。</p>
      <p class="text-sm text-gray-700"><strong>公証：</strong>自動スキャンでウイルス・改ざんのみチェック。数分で完了。</p>
    </Accordion>
  </AccordionGroup>
