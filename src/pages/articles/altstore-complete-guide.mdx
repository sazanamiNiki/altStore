...
<ArticleLayout title={title} h1={h1} description={description} date="2026-03-10" icon="apps" iconColor="text-blue-500">
    ...
    <table class="w-full border-collapse border border-gray-200">
      <thead>
        <tr class="bg-gray-100">
          <th class="border border-gray-200 px-2 sm:px-4 py-2 text-xs sm:text-sm text-left">項目</th>
          <th class="border border-gray-200 px-2 sm:px-4 py-2 text-xs sm:text-sm text-left">要件</th>
        </tr>
      </thead>
      <tbody>
        <tr>
          <td class="border border-gray-200 px-2 sm:px-4 py-2 text-xs sm:text-sm font-semibold">iOS</td>
          <td class="border border-gray-200 px-2 sm:px-4 py-2 text-xs sm:text-sm">iOS 14.4 以上</td>
        </tr>
        <tr class="bg-gray-50">
          <td class="border border-gray-200 px-2 sm:px-4 py-2 text-xs sm:text-sm font-semibold">PC/Mac</td>
          <td class="border border-gray-200 px-2 sm:px-4 py-2 text-xs sm:text-sm">Windows 10 以上、または macOS 10.14 以上</td>
        </tr>
        <tr>
          <td class="border border-gray-200 px-2 sm:px-4 py-2 text-xs sm:text-sm font-semibold">Apple ID</td>
          <td class="border border-gray-200 px-2 sm:px-4 py-2 text-xs sm:text-sm">無料アカウントで OK（2段階認証推奨）</td>
        </tr>
        <tr class="bg-gray-50">
          <td class="border border-gray-200 px-2 sm:px-4 py-2 text-xs sm:text-sm font-semibold">USB ケーブル</td>
          <td class="border border-gray-200 px-2 sm:px-4 py-2 text-xs sm:text-sm">データ転送対応のケーブル（初回のみ）</td>
        </tr>
      </tbody>
    </table>
  </div>
  ...
  <div class="overflow-x-auto mb-6">
    <table class="w-full border-collapse border border-gray-200">
      <thead>
        <tr class="bg-gray-100">
          <th class="border border-gray-200 px-2 sm:px-4 py-2 text-xs sm:text-sm text-left">項目</th>
          <th class="border border-gray-200 px-2 sm:px-4 py-2 text-xs sm:text-sm text-left">AltStore</th>
          <th class="border border-gray-200 px-2 sm:px-4 py-2 text-xs sm:text-sm text-left">SideStore</th>
        </tr>
      </thead>
      <tbody>
        <tr>
          <td class="border border-gray-200 px-2 sm:px-4 py-2 text-xs sm:text-sm font-semibold">PC 接続</td>
          <td class="border border-gray-200 px-2 sm:px-4 py-2 text-xs sm:text-sm">毎週必要（7日ごとの更新時）</td>
          <td class="border border-gray-200 px-2 sm:px-4 py-2 text-xs sm:text-sm">初回セットアップのみ</td>
        </tr>
        <tr class="bg-gray-50">
          <td class="border border-gray-200 px-2 sm:px-4 py-2 text-xs sm:text-sm font-semibold">アプリ更新方式</td>
          <td class="border border-gray-200 px-2 sm:px-4 py-2 text-xs sm:text-sm">AltServer 経由（Wi-Fi/USB）</td>
          <td class="border border-gray-200 px-2 sm:px-4 py-2 text-xs sm:text-sm">VPN 経由（完全オンデバイス）</td>
        </tr>
        <tr>
          <td class="border border-gray-200 px-2 sm:px-4 py-2 text-xs sm:text-sm font-semibold">開発体制</td>
          <td class="border border-gray-200 px-2 sm:px-4 py-2 text-xs sm:text-sm">Riley Testut 氏主導</td>
          <td class="border border-gray-200 px-2 sm:px-4 py-2 text-xs sm:text-sm">コミュニティ主導</td>
        </tr>
        <tr class="bg-gray-50">
          <td class="border border-gray-200 px-2 sm:px-4 py-2 text-xs sm:text-sm font-semibold">VPN 必要性</td>
          <td class="border border-gray-200 px-2 sm:px-4 py-2 text-xs sm:text-sm">不要</td>
          <td class="border border-gray-200 px-2 sm:px-4 py-2 text-xs sm:text-sm">必要（LocalDevVPN または StosVPN）</td>
        </tr>
        <tr>
          <td class="border border-gray-200 px-2 sm:px-4 py-2 text-xs sm:text-sm font-semibold">セットアップ難易度</td>
          <td class="border border-gray-200 px-2 sm:px-4 py-2 text-xs sm:text-sm">比較的簡単</td>
          <td class="border border-gray-200 px-2 sm:px-4 py-2 text-xs sm:text-sm">やや複雑（VPN 設定が必要）</td>
        </tr>
      </tbody>
    </table>
  </div>
  <CardGrid>
    <Card icon="computer" iconColor="text-blue-500" title="AltStoreを選ぶなら" desc="PC利用可・初心者向け" />
    <Card icon="phone_iphone" iconColor="text-green-500" title="SideStoreを選ぶなら" desc="完全オンデバイス運用" />
  </CardGrid>
</Section>
...
<Section title="まとめ" icon="done_all" iconColor="text-green-600">
  <CardGrid>
    ...
    <Card icon="construction" iconColor="text-blue-500" title="セットアップの流れ" desc="AltServer→USB→Wi-Fi設定" />
