...
<Section title="SideStoreとの比較" icon="compare" iconColor="text-green-600">
  ...
  <CardGrid>
    <Card icon="computer" iconColor="text-blue-500" title="AltStore" desc="PC接続型・初心者向け" />
    <Card icon="phone_iphone" iconColor="text-green-500" title="SideStore" desc="完全オンデバイス運用" />
  </CardGrid>
  <AccordionGroup>
    <Accordion title="詳しい違いを見る">
      <p class="text-sm text-gray-700 mb-2"><strong>AltStore：</strong>毎週PC接続が必要、AltServer経由で更新、VPN不要、セットアップ簡単</p>
      <p class="text-sm text-gray-700"><strong>SideStore：</strong>初回のみPC必要、VPN経由で完全オンデバイス、やや複雑なセットアップ</p>
    </Accordion>
  </AccordionGroup>
</Section>
