...
<Section intro title="AltStoreを使いこなすための完全ガイド" icon="lightbulb">
  ...
  <InfoBox type="indigo" icon="new_releases" title="AltStore PALが日本で無料利用可能に">
    2025年12月18日より、日本でも<strong>AltStore PAL</strong>（代替アプリマーケットプレイス版）が利用可能になりました。Epic Games MegaGrantにより<strong>完全無料</strong>。PC不要・7日制限なしで運用できます（iOS 26.2以降）。
  </InfoBox>
...
<Section title="AltStore Classic / PAL / SideStore 比較" icon="compare" iconColor="text-blue-600">
  ...
  <AccordionGroup>
    ...
    <Accordion title="SideStore（コミュニティ版）">
      ...
      <InfoBox type="warning" icon="warning" title="StosVPNについて">
        SideStoreの動作に必要なStosVPNは、2025年11月にApp Storeから削除されました。既にインストール済みであれば引き続き利用できますが、新規ユーザーは入手が困難です。
      </InfoBox>
    </Accordion>
  </AccordionGroup>
...
<Section title="SideStoreとの比較" icon="compare" iconColor="text-green-600">
  ...
  <AccordionGroup>
    <Accordion title="詳しい違いを見る">
      ...
      <InfoBox type="warning" icon="warning" title="SideStoreの注意点：StosVPNの入手困難化">
        SideStoreの動作に必要な<strong>StosVPN</strong>は、2025年11月にApp Storeから削除されました。既にインストール済みのユーザーは引き続き利用できますが、新規ユーザーは入手が困難です。PC不要での運用を希望する場合は、<strong>AltStore PAL</strong>の利用を検討してください。
      </InfoBox>
    </Accordion>
  </AccordionGroup>
</Section>
