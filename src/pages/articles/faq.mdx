...
<ArticleLayout title={title} description={description} date="2026-03-10" icon="help" iconColor="text-blue-500" faq={[
...
<Section intro title="気になることを1秒で解決" icon="lightbulb">
  <p class="text-gray-600 text-sm mb-3 sm:mb-4">質問をタップして答えを確認してください。</p>
  <CardGrid>
    <Card icon="security" iconColor="text-green-500" title="安全性・合法性" desc="3問" />
    <Card icon="settings" iconColor="text-blue-500" title="技術的な質問" desc="3問" />
    <Card icon="update" iconColor="text-orange-500" title="署名・デバイス" desc="4問" />
  </CardGrid>
</Section>
...
<Section title="安全性・合法性" icon="security" iconColor="text-green-600">
  <AccordionGroup>
    <Accordion title="Q. サイドローディングって危なくない？">
      <div class="flex items-center gap-2 p-2 sm:p-3 bg-green-50 rounded-lg border border-green-200 mb-4">
    ...
    <Accordion title="Q. セキュリティは大丈夫？">
      ...
      <CardGrid>
        <Card icon="check_circle" iconColor="text-green-500" title="安全" desc="公式リポジトリからのアプリ" />
        <Card icon="cancel" iconColor="text-red-500" title="危険" desc="海賊版・非公式アプリ" />
      </CardGrid>
...
<Section title="技術的な質問" icon="settings">
  <CardGrid>
    <Card icon="developer_mode" iconColor="text-gray-500" title="Developer Mode" desc="iOS 16以降の開発者モード。必要時に自動で案内が出る" />
  ...
  <AccordionGroup>
    <Accordion title="Q. Developer Mode（開発者モード）って何？">
      <div class="flex items-center gap-2 p-2 sm:p-3 bg-blue-50 rounded-lg border border-blue-200 mb-4">
...
<Section title="署名・アップデート・複数デバイス" icon="update">
  <AccordionGroup>
    ...
    <Accordion title="Q. AltStoreでうまくインストールできない時は？">
      ...
      <div class="my-3 sm:my-4 p-3 sm:p-4 bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 rounded-xl">
...
<Section title="まとめ" icon="done_all" iconColor="text-green-600">
  <div class="space-y-2 mb-6">
    <div class="flex items-center gap-2 sm:gap-3 p-2 sm:p-3 bg-white rounded-lg border border-gray-200">
      <span class="material-symbols-outlined text-green-500">check_circle</span>
